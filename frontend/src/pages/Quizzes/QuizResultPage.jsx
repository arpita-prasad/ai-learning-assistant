    ...
    <div className='max-w-5xl mx-auto'>
      ...
      <div className='bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 p-8 mb-8'>
        <div className='text-center space-y-6'>
          <div className='inline-flex items-center justify-center w-15 h-15 rounded-2xl bg-linear-to-br from-emerald-100 to-teal-100 shadow-emerald-500/25'>
      ...
      <div className='space-y-6'>
        ...
        {detailedResults.map((result, index) => {
          const cleanCorrectAnswer = result.correctAnswer.replace(/^\d+:\s*/, '');
          const cleanSelectedAnswer = result.selectedAnswer?.replace(/^\d+:\s*/, '') || '';
          const correctAnswerIndex = result.options.findIndex(opt => opt === cleanCorrectAnswer);
          const userAnswerIndex = result.options.findIndex(opt => opt === cleanSelectedAnswer);
          ...
          return (
            ...
            >
              <div className='flex items-start justify-between gap-4 mb-3'>
                ...
                <div className={`shrink w-10 h-10 rounded-xl flex items-center justify-center ${
                  isCorrect
              ...
              <div className='space-y-3 mb-4'>
                {result.options.map((option, optIndex) => {
                  ...
                  const isCorrectUserAnswer = isUserAnswer && isCorrect;
