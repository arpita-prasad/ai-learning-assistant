      ...
      <div className='flex items-center justify-between gap-4'>
        <Button
          ...
          {currentQuestionIndex === quiz.questions.length - 1 ? (
            ...
            disabled={submitting}
            className='group relative px-8 h-12 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold text-sm rounded-xl transition-all duration-200 shadow-lg shadow-emerald-500/25 active:scale-95 disabled:opacity-95 disabled:cursor-not-allowed disabled:active:scale-100 overflow-hidden'
            >
